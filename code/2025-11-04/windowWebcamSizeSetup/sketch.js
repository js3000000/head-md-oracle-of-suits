...
function draw() {
  ...
  if (detections) {
   ...
   /*    let indexTip = hand[FINGER_TIPS.index];
      ...
      let indexfingerx = indexTip.x * videoDrawW + videoDrawX;
      let indexfingerY = indexTip.y * videoDrawH + videoDrawY;
      
      let thumbTip = hand[FINGER_TIPS.thumb];
      let thumbfingerx = thumbTip.x * videoDrawW + videoDrawX;
      let thumbfingerY = thumbTip.y * videoDrawH + videoDrawY; */
